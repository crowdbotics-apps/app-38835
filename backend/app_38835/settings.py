"""
Django settings for app_38835 project.
...
WSGI_APPLICATION = 'app_38835.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "app_38835 API",
    "DESCRIPTION": "API documentation for app_38835 App",
    "VERSION": "v1",
}
